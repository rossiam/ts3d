...
* https://deno.com
* https://openscad.org; need a development snapshot or nightly build from https://openscad.org/downloads.html#snapshots to render STL
...
* `.chamfer` and `round`
* no fillet but you can use `difference` to subtract a chamfered or rounded shape to get a fillet
* `.move`
* `text3d`
